...
- 주소는 `/now` 하나입니다. 예전 주보별 링크(`/share/<토큰>`)는 이쪽으로 넘겨줍니다
...
> 주보에 담기는 것은 **그 주보 달의 명단 하나뿐**입니다. 공유 QR 링크를 받은 사람이
> 다른 달 명단까지 들여다볼 수 없도록 저장할 때 잘라냅니다(`src/lib/backend/map.ts`).
...
src/
  app/
    ...
    share/[token]/     예전 주보별 링크 — /now 로 넘겨준다
