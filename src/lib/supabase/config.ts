 ...
 *   /manual 사용자 매뉴얼 PDF. 가입하려는 사람이 로그인 화면에서 미리 받아본다.
 *           (관리자 매뉴얼은 여기 없다 — /api/manual/admin이 역할을 확인하고 내보낸다)
 */
export const PUBLIC_PATHS = ["/login", "/signup", "/reset-password", "/now", "/auth", "/manual"];
